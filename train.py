#!/usr/bin/env python3
"""
Thin CLI: load data, standardize x, train with batch GD, convert thetas back, save JSON.
"""

from __future__ import annotations
import argparse
from src.linear_regression.model import (
    load_csv, save_thetas, mean_std, standardize, train_batch_gradient_descent
)
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--epochs", type=int, default=20000, help="Number of gradient steps")
